...
function (_PureComponent) {
    ...
    _this.renderRuler = function () {
      ...
      for (var i = start; i < end + step; i += step) {
        if (i % 10 === 0 || i === end || step === 1 && i % 5 === 0) {
          ruleDiv = React.createElement("div", {
            key: i,
            className: "rule-mark",
            style: i === end + 1 || i === end ? {} : {
            ...
            className: "line-text"
          }, i === end + 1 ? end : i), React.createElement("div", {
            className: "line"
          }));
        } else {
          ruleDiv = React.createElement("span", {
            key: i,
            className: "line",
            style: {
              width: "".concat(stepWidth, "%")
  ...
  createClass(Ruler, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
      ...
      }, this.renderRuler()), React.createElement("div", {
        ...
        className: "point"
      }, value || start), React.createElement("div", {
