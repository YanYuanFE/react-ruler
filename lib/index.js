(function (global, factory) {
  ...
  (global = global || self, global.Ruler = factory(global.React, global.PropTypes));
  ...
  var MapSubscriber = (function (_super) {
      __extends$2(MapSubscriber, _super);
  ...
  var FilterSubscriber = (function (_super) {
      __extends$3(FilterSubscriber, _super);
  ...
  var CatchSubscriber = (function (_super) {
      __extends$6(CatchSubscriber, _super);
  ...
  var ScanSubscriber = (function (_super) {
      __extends$7(ScanSubscriber, _super);
  ...
  var DoSubscriber = (function (_super) {
      __extends$8(DoSubscriber, _super);
  ...
  var EmptyObservable = (function (_super) {
      __extends$a(EmptyObservable, _super);
  ...
  var ArrayObservable = (function (_super) {
      __extends$b(ArrayObservable, _super);
  ...
  var TakeUntilSubscriber = (function (_super) {
      __extends$d(TakeUntilSubscriber, _super);
  ...
  var FirstSubscriber = (function (_super) {
      __extends$f(FirstSubscriber, _super);
  ...
  var ArgumentOutOfRangeError = (function (_super) {
      __extends$g(ArgumentOutOfRangeError, _super);
  ...
  var ElementAtSubscriber = (function (_super) {
      __extends$h(ElementAtSubscriber, _super);
  ...
  var FromEventObservable = (function (_super) {
      __extends$i(FromEventObservable, _super);
  ...
  var TimerObservable = (function (_super) {
      __extends$m(TimerObservable, _super);
  ...
  function getDragObservables(domItem) {
    ...
    var holds = _starts.concatMap(function (dragStartEvent) {
      return Observable_2.timer(HOLDING_PERIOD).takeUntil(_moves.elementAt(3)).takeUntil(_ends).map(function () {
        return {
          x: dragStartEvent.x,
          y: dragStartEvent.y
        };
  ...
  function (_PureComponent) {
    ...
    function Ruler(props) {
      ...
      _this = possibleConstructorReturn(this, getPrototypeOf(Ruler).call(this, props));

      _this.transform = function (offsetWidth) {
      ...
      _this.tranformScore = function (dragVal) {
        var _this$props2 = _this.props,
            start = _this$props2.start,
            end = _this$props2.end,
            onDrag = _this$props2.onDrag;
        var value = Math.round((end - start) * dragVal / _this.containerWidth + start);
      ...
      _this.registerDragListener = function () {
        ...
        var dragObserver = getDragObservables(point);

        var dragStart = function dragStart(_ref) {
          var x = _ref.x;
          _this.startPercentage = _this.state.percentage;

          _this.onDragStart(x);
        };

        var dragMoves = function dragMoves(_ref2) {
          var x = _ref2.x;
          var currPercentage = _this.startPercentage + x / width;
          ...
          _this.setState({
            ...
            return _this.onDrag(_this.state.offsetWidth);
          });
        };
        ...
        var dragEnds = function dragEnds() {
          ...
          _this.onDragEnd(_this.state.percentage);
        };
        ...
        var barClickObserver = getDragObservables(ruler);

        var barClick = function barClick(_ref3) {
          var x = _ref3.x;
          var wrapperLeft = ruler.getBoundingClientRect().left;
      ...
      _this.renderRuler = function () {
        ...
        for (var i = start; i < end + step; i += step) {
          if (i % 10 === 0 || i === end || step === 1 && i % 5 === 0) {
            ruleDiv = React__default.createElement("div", {
              key: i,
              className: "rule-mark",
              style: i === end + 1 || i === end ? {} : {
              ...
              className: "line-text"
            }, i === end + 1 ? end : i), React__default.createElement("div", {
              className: "line"
            }));
          } else {
            ruleDiv = React__default.createElement("span", {
              key: i,
              className: "line",
              style: {
                width: "".concat(stepWidth, "%")
    ...
    createClass(Ruler, [{
      ...
      value: function render() {
        ...
        return React__default.createElement("div", {
        ...
        }, this.renderRuler()), React__default.createElement("div", {
          ...
          className: "point"
        }, value || start), React__default.createElement("div", {
